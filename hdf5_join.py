...
def myjoin(joined_file, myfiles) :
...
runnum = sys.argv[1]
files = glob.glob('/sdf/data/lcls/ds/tmo/tmol1030922/scratch/preproc/v1/*'+runnum+'*part*.h5')
joined_file = h5py.File('/sdf/data/lcls/ds/tmo/tmol1030922/scratch/preproc/v1/run'+runnum+'_v1_cpo.h5', 'w', libver='latest')

myjoin(joined_file, files)
